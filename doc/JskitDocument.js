        function JskitDocument(rHd){
	this.hd = (typeof(rHd)!="string")?"jskitDocument":rHd;
}
JskitDocument.prototype.showBaseInfo = function(rData){
	
};
JskitDocument.prototype.showValues = function(rData){
	
};
JskitDocument.prototype.__pageLayoutBefore = function(){
...
JskitDocument.prototype.__pageLayoutEnd = function(){
	var str = "		<!--////////////////////////////////////////////-->";
	str += "		</div>";
	str += "		</td>";
    str += "	</tr>";
...
JskitDocument.prototype.pageOnLoad = function(){
