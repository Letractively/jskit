...
var n3 = tree.newNode(n0, false, "Tutorial", "");
    ...
    var np1 = tree.newNode(np, false, "动画", "");
        tree.newNode(np1, true, "对象拖动和改变大小", "demo/demo_dynamic.html");
	    tree.newNode(np1, true, "对象的动态移动", "demo/demo_animation.html");
	    tree.newNode(np1, true, "页面效果", "demo/effects.html");
	    np1 = tree.newNode(np, false, "表单和控件", "");
    	tree.newNode(np1, true, "表单验证", "demo/demo_JskitValidation.html");
	    tree.newNode(np1, true, "翻页器", "demo/demo_JskitPager.html");
        tree.newNode(np1, true, "日期输入控件", "demo/date_selector.html");
        tree.newNode(np1, true, "高级下拉列表", "demo/demo_richselect.html");
        tree.newNode(np1, true, "菜单和树", "demo/demo_menu.html");
        tree.newNode(np1, true, "数据表视图", "demo/demo_gridview.html");
        np1 = tree.newNode(np, false, "集成效果", "");
        tree.newNode(np1, true, "倒计时器", "demo/timer.html");
        tree.newNode(np1, true, "顺序执行任务", "demo/task.html");
        tree.newNode(np1, true, "显示日历", "demo/demo_calendar.html");
        tree.newNode(np1, true, "显示一个相册", "demo/demo_JskitAlbum.html");
        np1 = tree.newNode(np, false, "广告组件", "");
        tree.newNode(np1, true, "轮显广告", "demo/demo_JskitSlidAd.html");
        tree.newNode(np1, true, "滚动图片组", "demo/demo_JskitSmartAD_VRoll.html");
        np1 = tree.newNode(np, false, "其他组件", "");
